package lintend.pabson.bhaktapur.school.ButtomNavbarActivity.More.InsideMore.Profile_school;
...
public class ProfileActivitySchool extends AppCompatActivity {
    ...
    String dialSchoolnumber, dialPrincipalNum;
   // SwipeRefreshLayout refresh;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.profile_layout_school);
        ...
        dialNumberPrincipal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ProfileActivitySchool.this, "Unsuccessful", Toast.LENGTH_SHORT).show();
                }
